  ...
  return (
    <div className={styles.container}>
      <div className={styles.fullWidthContainer}>
        <h2 className={styles.textGreen}>Manage Holidays</h2>
      </div>
        ...
        <di className={style.rightDiv}>
          ...
          <div className={style.cardContainer}>
            <div className={style.card}>
              <div>
                <p className={style.cardText}>Rangwali Holi </p>
                <pre style={{ margin: "0" }}>Start Date : Feb 21, 2023</pre>
                <pre>End Date : Feb 23, 2023</pre>
            ...
            <div className={style.card}>
              <div>
                <p className={style.cardText}>Good Friday</p>
                <pre style={{ margin: "0" }}>Start Date : Feb 21, 2023</pre>
                <pre>End Date : Feb 23, 2023</pre>
                {/* <p>Feb 17, 2023 11:35 AM</p> */}
              </div>
            ...
            <div className={style.card}>
              <div>
                <p className={style.cardText}>Janmashtami</p>
                <pre style={{ margin: "0" }}>Start Date : Feb 21, 2023</pre>
                <pre>End Date : Feb 23, 2023</pre>
              </div>
              <div
